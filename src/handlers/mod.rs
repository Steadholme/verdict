...
/// Embedded design system (Odyssey canonical + Verdict service CSS), inlined into each
...
/// Render the shared app-bar: shield + Steadholme wordmark on the left; an "All apps" link back to
...
pub fn topbar(page_title: &str, email: &str) -> String {
  ...
  <div class="topbar__inner">
    <a class="brand" href="/" aria-label="Steadholme Verdict">
...
<title>{code} {reason} · Verdict</title><style>{css}</style></head>
